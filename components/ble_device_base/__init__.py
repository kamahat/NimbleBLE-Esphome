...
SURCHARGE NimbleBLE-Esphome : identique au core (aucune modification --
seul ble_device.h/.cpp a une dépendance Bluedroid cachée corrigée via
esp_bt_defs_compat.h, voir docs/ARCHITECTURE.md "Découverte majeure").
