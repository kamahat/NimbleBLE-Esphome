// SURCHARGE NimbleBLE-Esphome : identique au core -- concept C++20
// platform-neutre, aucune dépendance Bluedroid (voir docs/ARCHITECTURE.md,
// "Découverte majeure" : ce fichier définit le contrat que notre futur
// backend NimBLE (components/bluetooth_connection/) devra satisfaire).
//
// ble_gatt_client.h
//
