...
//
// SURCHARGE NimbleBLE-Esphome: seule ligne modifiée vs le core --
// #include <esp_bt_defs.h> remplacé par "esp_bt_defs_compat.h" (quoted,
// même répertoire). Voir esp_bt_defs_compat.h pour la raison exacte.
